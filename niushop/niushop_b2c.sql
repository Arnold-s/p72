...
-- Script date 2017/12/22 18:51:22
...
-- Table aaa.ns_member does not contain any data (it is empty)
...
-- Table aaa.ns_shop_navigation does not contain any data (it is empty)
